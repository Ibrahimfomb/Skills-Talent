...
public class ClaudeApiService {
    ...
    private String buildCandidatePrompt(Map<String, String> answers) {
        ...
        return "Tu es un expert en matching emploi pour la plateforme SkillSet.\n"
            ...
            + "Pays : " + country + "\n"
            + "Ville : " + city + "\n"
            + "Toutes les réponses initiales :\n" + alreadyKnown + "\n\n"
            + "=== CONTEXTE GÉOGRAPHIQUE ===\n"
            + geoNote + "\n\n"
            + "=== INSTRUCTIONS DE GÉNÉRATION ===\n"
            + "Génère entre 8 et 14 questions selon la complexité du métier \"" + domain + "\".\n"
            + "Questions pour enrichir le profil de matching — PAS un contrôle, PAS un audit.\n"
            + "Chaque question apporte une information UNIQUE utile au matching.\n"
            ...
            + "- JAMAIS de question déjà couverte par le contexte ci-dessus\n"
            + "- Les options sont TOUJOURS spécifiques au pays \"" + country + "\"\n"
            + "- PAS de question de vérification d'identité ou de légitimité\n\n"
    ...
    private String buildEmployerPrompt(Map<String, String> answers) {
        ...
        return "Tu es un expert en matching emploi pour la plateforme SkillSet.\n"
            ...
            + "Questions pour décrire précisément le besoin — PAS un audit, PAS une vérification de légitimité.\n"
            + "Chaque question apporte une information UNIQUE pour le matching candidat/offre.\n"
            ...
            + "- PAS de question de vérification d'identité ou d'audit de légitimité\n\n"
            + "FORMAT JSON STRICT (sans markdown, sans texte avant/après) :\n"
